...
for i in range(len(dataset)):
    ...
    traindatalist.append([train_g,train_pos_g,train_neg_g])
    testdatalist.append([train_g,test_pos_g,test_neg_g])

trainloader = simple_dataloader(traindatalist,shuffle=False)
testloader = simple_dataloader(testdatalist,shuffle=False)
...
# ----------- 4. training -------------------------------- #
h_list = []
for idx, (train_g,train_pos_g,train_neg_g) in enumerate(trainloader):
    print("=============================================")
    print("graph:",idx)
    # all_logits = []
    for e in range(100):
...
auc_list = []
for idx, (test_g,test_pos_g,test_neg_g) in enumerate(testloader):
    print("=============================================")
    print("graph:", idx)
    h = h_list[idx]
    ...
    with torch.no_grad():
        ...
        auc_list.append(compute_auc(pos_score, neg_score))

print("==================================================")
print("avg AUC:", np.array(auc_list).mean())